...
(function () {
   ...
   */ var shapes = {
    square:
      '<path d="M45.9 52.7H14.1c-3.9 0-7-3.1-7-7V13.8c0-3.9 3.1-7 7-7h31.8c3.9 0 7 3.1 7 7v31.8C52.9 49.5 49.8 52.7 45.9 52.7z"/>',
  ...
  app.svg.shape = function (options) {
    ...
    var scopeCircle = opts.circleColor
      ...
      : "";
    var dataKind = !opts.circleColor ? ' data-kind="' + opts.kind + '"' : "";
...
(function () {
  ...
  function getSidebarNavItemInner(
    ...
    if (noBadge) {
      ...
      badge =
        '<div class="symbol-badge badge-str"><span>' + badge + "</span></div>";
      labelMargin = 25;
    } else {
      labelMargin = 31;
    }
...
(function () {
  ...
  docma
    ...
    .addFilter("$tags", function (symbol) {
      var openIce = '<span class="boxed vertical-middle bg-ice opacity-full">',
        openIceDark =
...
(function () {
  ...
  function toggleSubTree(elem, fold) {
    fold = typeof fold !== "boolean" ? !elem.hasClass("members-folded") : fold;
    var parent;
    if (fold) {
